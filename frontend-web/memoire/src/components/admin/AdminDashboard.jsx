...
const AdminDashboard = () => {
  ...
  const fetchDashboardStats = async () => {
    ...
    try {
      ...
      const usersResponse = await fetch('https://20250428t092311-dot-memoire-it342.as.r.appspot.com/api/users/admin/dashboard', {
        method: 'GET',
        headers: {
      ...
      const reportsResponse = await fetch('https://20250428t092311-dot-memoire-it342.as.r.appspot.com/api/reports', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${authToken}`,
          'Content-Type': 'application/json'

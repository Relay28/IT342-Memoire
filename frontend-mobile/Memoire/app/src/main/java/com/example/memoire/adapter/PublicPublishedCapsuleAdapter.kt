...
class PublicPublishedCapsulesAdapter(
...
) : RecyclerView.Adapter<PublicPublishedCapsulesAdapter.CapsuleViewHolder>() {
    ...
    inner class CarouselAdapter(private val contents: List<CapsuleContentEntity>) :
        ...
        override fun onBindViewHolder(holder: CarouselViewHolder, position: Int) {
            ...
            if (content.contentType?.startsWith("image/") == true||content!=null) {
